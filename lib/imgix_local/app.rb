 ...
 private
  ...
  def generate_image(image_name, width, height)
    ...
    original_image.combine_options do |c|
      ...
      c.fill(semi_random_rgb(image_name.slice(0)))
